...
//     cy.get('svg.feather-help-circle').click();
// //    cy.get('#content-container a[href="/tech-details"]')
// //    .invoke('removeAttr', 'target') // use same tab for testing (prevent opening a new one)    
// //    .click();
//     cy.get('#content-container a[href="https://github.com/twenty-eighty/pareto-client"]')
//     .invoke('removeAttr', 'target') // use same tab for testing (prevent opening a new one)
//     .click();
